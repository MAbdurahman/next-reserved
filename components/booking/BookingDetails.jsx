	...
	return (
		<div className='container'>
			<div className='row d-flex justify-content-between'>
				<div className='col-12 col-lg-8 mt-5 booking-details booking-details-box'>
					{booking && booking.room && booking.user && (
						<> 
							<h2 className='my-5'>Reservation # {booking._id}</h2>
							...
							<h4 className='mb-4'>Reservation Info</h4>
							<p>
								<b>Check In:</b>{' '}
							...
							<h4 className='mt-5 mb-4'>Reserved Room:</h4>
